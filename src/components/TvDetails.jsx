  ...
  return info ? (
    ...
    >
        ...
        <div className="content ml-[5%] ">
          ...
          <div className="mt-2 text-sm text-zinc-50 font-light flex flex-col items-start">
            <p className="flex flex-wrap items-center gap-x-7">
              <span>Released on : {info.detail.last_air_date}</span>
      ...
      <div className="max-w-screen-xl mx-auto py-5">
        ...
        <h1 className="text-xl font-semibold tracking-wide  mt-4 text-zinc-200" >Seasons</h1>
        ...
        <h1 className="text-xl font-semibold tracking-wide mt-4 text-zinc-200" >Recommmendations and Similar stuff</h1>
